...
<body>
	...
	<div style="height: 550px; width: 700px; margin: 10px auto;">
		<form class="layui-form layui-form-pane" name="form1"
			action="${pageContext.request.contextPath}/admin/addClub">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" id="name" name="name" class="layui-input"
						value="${addClub.name }" lay-verify="required" lay-reqText="社团名不能为空"/>
				</div>
			</div>
			<div class="layui-form-item" pane>
				<label class="layui-form-label" style="background-color: rgba(57, 61, 73, 0.1)">社团类型</label>
				<div class="layui-input-block">
					<c:if test="${addClub.clubType==null }">
					...
					<c:if test="${addClub.clubType!=null }">
						<select name="clubTypeId" id="clubTypeId">
							<c:forEach items="${clubTypes }" var="i">
								<c:if test="${addClub.clubType.id==i.id}">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" id="studentId" name="studentId"
						class="layui-input" value="${addClub.student.id }" lay-verify="sid"/>
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" id="place" name="place" class="layui-input"
						value="${addClub.place }" lay-verify="required" lay-reqText="社团活动地点不能为空"/>
				</div>
			</div>
            <div class="layui-form-item ">
                ...
                <div class="layui-input-block">
                    <c:if
                        test="${addClub.status==0 ||(addClub.status!=1&&addCLub.status!=0)}">
                        <input type="radio" name="status" value="0" title="正常" checked>
                        <input type="radio" name="status" value="1" title="停止">
                    </c:if>
                    <c:if test="${addClub.status==1 }">
			...
			<div class="layui-form-item layui-form-text">
				...
				<div class="layui-input-block">
					<textarea name="introduce" placeholder="请输入内容"
						value="${addClub.introduce}" class="layui-textarea"></textarea>
				</div>
			</div>
			<div class="layui-form-item layui-form-text">
				...
				<div class="layui-input-block">
					<textarea name="notice" placeholder="请输入内容"
						value="${addClub.notice}" class="layui-textarea"></textarea>
				</div>
			</div>
