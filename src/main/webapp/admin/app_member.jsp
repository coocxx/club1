...
<body>
    ...
    <div
        ...
        <form class="layui-form" method="post" name="form1"
            ...
            action="${pageContext.request.contextPath }/admin/selAppMembers">
    ...
    <c:if test="${ curPage.data!=null && curPage.data.size()!=0 }">
                        ...
                        <tr>
                            ...
                            <td>
                              <div> <a class="layui-btn layui-btn-radius layui-btn-normal"
                                href="${pageContext.request.contextPath }/admin/selAppMemberById?id=${i.id }" >详情</a>
                                </div><div>
                                <c:if test="${i.status==2 }"><div><a class="layui-btn layui-btn-radius"
                                href="${pageContext.request.contextPath }/admin/updAppMemberStatus?id=${i.id }&studentId=${i.student.id }&clubId=${i.club.id }&status=1" onclick="return updConfirm()">通过</a>
                                </div></c:if>
                                
                                <c:if test="${i.status==2 }"><div><a class="layui-btn layui-btn-radius layui-btn-warm"
                                href="${pageContext.request.contextPath }/admin/updAppMemberStatusR?id=${i.id }&studentId=${i.student.id }&status=0" onclick="return rejConfirm()">拒绝</a>
                                </c:if></div>
                              </td>
                        </tr>
                    </c:forEach>
        ...
        <div style="margin: 10px 0px 10px 380px">
            ...
            <c:if test="${curPage.curPage!=1}">
                <a class="layui-btn"
                    href="${pageContext.request.contextPath }/admin/selAppMemberByPage?curPage=1">首页</a>
            </c:if>
            <!-- 上一页 -->
            <c:if test="${curPage.curPage<=1}">
                <a class="layui-btn layui-btn-primary"
            ...
            <c:if
                ...
                <a class="layui-btn"
                    href="${pageContext.request.contextPath }/admin/selAppMemberByPage?curPage=${curPage.curPage-1 }"><i
            ...
            <c:if test="${curPage.curPage!=curPage.totalPage}">
                <a class="layui-btn"
                    href="${pageContext.request.contextPath }/admin/selAppMemberByPage?curPage=${curPage.totalPage }">尾页</a>
            </c:if>
        </div>
    </c:if>
    <script>
