...
<body>
    ...
    <div
        ...
        <a href="${pageContext.request.contextPath}/admin/selNewsByPage?action=pr"><i
    ...
    <div style="width: 750px; margin: 10px auto;">
        <form class="layui-form layui-form-pane" name="form1"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="people" id="people"  value="${news.people }" class="layui-input" readonly="readonly" />
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="time" id="time" value="${news.time }" class="layui-input" readonly="readonly"/>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="count" id="count" value="${news.count }"  class="layui-input" readonly="readonly"/>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" id="title" name="title" class="layui-input"
                        value="${news.title }" readonly="readonly"/>
                </div>
            </div>
            ...
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                    <textarea name="content" placeholder="请输入内容" class="layui-textarea" readonly="readonly" 
