...
<body>
	...
	<div
		...
		<a href="${pageContext.request.contextPath}/admin/selMemberQuitByPage"><i
		...
		<form class="layui-form layui-form-pane" name="form1"
			...
			<div class="layui-form-item" style="margin-left:250px;margin-top: 30px">
				<a class="layui-btn layui-btn-radius" style="width:130px"
					href="${pageContext.request.contextPath }/admin/delMemberQuit?id=${member.id }"
					onclick="return delConfirm()">删除</a>
				<a class="layui-btn layui-btn-radius layui-btn-primary" style="width:130px" href="${pageContext.request.contextPath}/admin/selMemberQuitByPage">返回</a>
			</div>
