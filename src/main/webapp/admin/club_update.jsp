...
<body>
    ...
    <div style="margin: 30px 0px 0px 220px; align: center; color: rgba(57, 61, 73, 0.7)">
         <a href="${pageContext.request.contextPath}/admin/selClubByPage"><i class="layui-icon"> &#xe603;返回</i></a>
     </div>
    <h2
    ...
    <div style="height: 550px; width: 750px; margin: 10px auto;">
        <form class="layui-form layui-form-pane" name="form1"
            action="${pageContext.request.contextPath}/admin/updClub">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" id="id" name="id" class="layui-input"
                        value="${club.id }" readonly="readonly"/>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" id="name" name="name" class="layui-input"
                        value="${club.name }"  readonly="readonly"/>
                </div>
            </div>
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                        ...
                        <!--  -->
                        <c:if test="${club.clubType.name!=null }">
                            <option value="${club.clubTypeId  }">&emsp;${club.clubType.name }&emsp;</option>
                        </c:if>
                        <c:if test="${club.clubType.name==null }">
                            <option value="${club.clubTypeId  }">其他</option>
                        </c:if>
                        </select>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" id="studentId" name="studentId"
                        class="layui-input" value="${club.student.id }" readonly="readonly"/>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" id="place" name="place" class="layui-input"
                        value="${club.place }" lay-verify="required" />
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <c:if
                        test="${club.status==0 ||(club.status!=1 && club.status!=0)}">
            ...
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                    <textarea name="introduce" placeholder="请输入内容"
                        class="layui-textarea">${club.introduce}</textarea>
                </div>
            </div>
            <div class="layui-form-item layui-form-text">
                <label class="layui-form-label" style="background-color: rgba(57, 61, 73, 0.1)">社团宗旨</label>
                <div class="layui-input-block">
                    <textarea name="notice" placeholder="请输入内容"
                         class="layui-textarea">${club.notice}</textarea>
                </div>
            </div>
