...
<body>
    ...
    <div style="width: 700px; margin: 10px auto;">
        <form class="layui-form layui-form-pane" name="form1"
            action="${pageContext.request.contextPath}/admin/addEvent">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" id="studentId" name="student.id" class="layui-input"
                        value="${event.student.id }" lay-verify="required" />
                </div>
            </div>
