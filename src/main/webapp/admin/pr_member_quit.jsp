...
<body>
    ...
    <!-- 按条件查询 -->
    <div
        style="margin: 0px auto; background-color: rgba(57, 61, 73, 0.1); height: 150px;">
        <form class="layui-form" method="post" name="form1"
            style="margin-left: 70px; padding-top: 20px;"
            action="${pageContext.request.contextPath }/admin/selMemberQuits?active=pr">
    ...
    <c:if test="${ curPage.data!=null && curPage.data.size()!=0 }">
                        ...
                        <tr>
                            ...
                            <td>
                               <div> <a class="layui-btn layui-btn-normal"
                                href="${pageContext.request.contextPath }/admin/selMemberQuitById?active=pr&id=${i.id }"
                                >详情</a></div>
                                <div>
                                <a class="layui-btn "
                                href="${pageContext.request.contextPath }/admin/delMemberQuit?active=pr&id=${i.id }"
        ...
        <div style="margin: 10px 0px 10px 380px">
            ...
            <c:if test="${curPage.curPage!=1}">
                <a class="layui-btn"
                    href="${pageContext.request.contextPath }/admin/selMemberQuitByPage?active=pr&curPage=1">首页</a>
            </c:if>
            <!-- 上一页 -->
            <c:if test="${curPage.curPage<=1}">
                <a class="layui-btn layui-btn-primary"
            ...
            <c:if
                ...
                <a class="layui-btn"
                    href="${pageContext.request.contextPath }/admin/selMemberQuitByPage?active=pr&curPage=${curPage.curPage-1 }"><i
            ...
            <c:if test="${curPage.curPage!=curPage.totalPage}">
                <a class="layui-btn"
                    href="${pageContext.request.contextPath }/admin/selMemberQuitByPage?active=pr&curPage=${curPage.totalPage }">尾页</a>
            </c:if>
        </div>
    </c:if>
    <script>
