...
<body>
	...
	<div
		...
		<a href="${pageContext.request.contextPath}/admin/selMemberQuitByPage?active=pr"><i
	...
	<div style="width: 700px; margin: 10px 160px;">
		<form class="layui-form layui-form-pane" name="form1"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" id="id" name="id" class="layui-input"
						style="color:; text-align: center" value="${member.id }"
						readonly="readonly" />
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="student.name" class="layui-input"
						style="text-align: center" value="${member.student.name }"
						readonly="readonly" />
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" id="clubId" name="club.id" class="layui-input"
						style="text-align: center" value="${member.club.id }"
						readonly="readonly" />
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="club.name" class="layui-input"
						style="text-align: center" value="${member.club.name }"
						readonly="readonly" />
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label"
					style="background-color: rgba(57, 61, 73, 0.1)">退出时间</label>
				<div class="layui-input-block">
			...
			<div class="layui-form-item" style="margin-left:250px;margin-top: 30px">
				<a class="layui-btn layui-btn-radius" style="width:130px"
					href="${pageContext.request.contextPath }/admin/delMemberQuit?active=pr&id=${member.id }"
					onclick="return delConfirm()">删除</a>
				<a class="layui-btn layui-btn-radius layui-btn-primary" style="width:130px" href="${pageContext.request.contextPath}/admin/selMemberQuitByPage?active=pr">返回</a>
			</div>
