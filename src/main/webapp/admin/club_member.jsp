...
<body>
    ...
    <div
        ...
        <form class="layui-form" method="post" name="form1"
            ...
            action="${pageContext.request.contextPath }/admin/selClubMembers">
    ...
    <c:if test="${ curPage.data!=null && curPage.data.size()!=null }">
                    ...
                    <c:forEach items="${curPage.data }" var="i">
                        <tr>
                            ...
                            <td><div><a class="layui-btn layui-btn-radius layui-btn-normal"
                                href="${pageContext.request.contextPath }/admin/preUpdClubMember?id=${i.id }"><i class="layui-icon">&#xe642;编辑</i></a>
                                    </div>
                                <div><a class="layui-btn layui-btn-radius"
                                href="${pageContext.request.contextPath }/admin/delClubMember?id=${i.id }"
                                ...
                                <c:if test="${i.status==0 || i.status==1}">
									<div>
										<a class="layui-btn layui-btn-radius layui-btn-warm"
											href="${pageContext.request.contextPath }/admin/quitClubMember?id=${i.id }&clubId=${i.clubId}&studentId=${i.studentId}"
        ...
        <div style="margin: 10px 0px 10px 380px">
            ...
            <c:if test="${curPage.curPage!=1}">
                <a class="layui-btn"
                    href="${pageContext.request.contextPath }/admin/selClubMemberByPage?curPage=1">首页</a>
            </c:if>
            <!-- 上一页 -->
            <c:if test="${curPage.curPage<=1}">
                <a class="layui-btn layui-btn-primary"
            ...
            <c:if
                ...
                <a class="layui-btn"
                    href="${pageContext.request.contextPath }/admin/selClubMemberByPage?curPage=${curPage.curPage-1 }"><i
            ...
            <c:if test="${curPage.curPage!=curPage.totalPage}">
                <a class="layui-btn"
                    href="${pageContext.request.contextPath }/admin/selClubMemberByPage?curPage=${curPage.totalPage }">尾页</a>
            </c:if>
        </div>
    </c:if>
    <script>
