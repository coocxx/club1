...
<body>
    ...
    <div style="margin:0px auto;background-color:rgba(57, 61, 73, 0.1);height:130px;">
        ...
        <form class="layui-form" method="post" name="form1" style="margin-left:70px;padding-top: 20px;"
            action="${pageContext.request.contextPath }/admin/selMajors">
            <div class="layui-form-item">
                <div class="layui-inline">
                    <label class="layui-form-label">学院号:</label>
                    <div class="layui-input-inline" style="width: 150px;">
                        <input type="text" name="academy.id"  id="academyId" class="layui-input" />
                    </div>
                </div>
                <div class="layui-inline">
                    <label class="layui-form-label">学院名:</label>
                    <div class="layui-input-inline" style="width: 150px;">
                        <input type="text" name="academy.name" class="layui-input" />
                    </div>
                </div>
                <div class="layui-inline">
    ...
    <c:if test="${ curPage.data!=null && curPage.data.size()!=null }">
            ...
            <table class="layui-table" style="text-align:center">
                ...
                <thead>
                    <tr >
                        ...
                        <th style="text-align:center">专业名</th>
                ...
                <tbody>
                    <c:forEach items="${curPage.data }" var="i">
                        <tr>
                            <td>${i.academy.id }</td>
                            <td>${i.academy.name }</td>
                            <td>${i.id }</td>
                            <td>${i.name }</td>
                            <td><a class="layui-btn layui-btn-radius layui-btn-normal"
                                href="${pageContext.request.contextPath }/admin/selMajorById?id=${i.id }"><i class="layui-icon">详情</i></a>
        ...
        <div style="margin: 10px 0px 10px 380px">
            ...
            <c:if test="${curPage.curPage!=1}">
                <a class="layui-btn"
                    href="${pageContext.request.contextPath }/admin/selMajorByPage?curPage=1">首页</a>
            </c:if>
            <!-- 上一页 -->
            <c:if test="${curPage.curPage<=1}">
                <a class="layui-btn layui-btn-primary"
            ...
            <c:if
                ...
                <a class="layui-btn"
                    href="${pageContext.request.contextPath }/admin/selMajorByPage?curPage=${curPage.curPage-1 }"><i class="layui-icon layui-icon-left"></i></a>
            </c:if>
            <!-- 下一页 -->
            ...
            <c:if
                test="${(curPage.curPage>=1) && (curPage.curPage<curPage.totalPage)}">
                <a class="layui-btn"
                    href="${pageContext.request.contextPath }/admin/selMajorByPage?curPage=${curPage.curPage+1 }"><i class="layui-icon">&#xe602;</i></a>
            </c:if>
            <!-- 尾页 -->
            <c:if test="${curPage.curPage==curPage.totalPage}">
                <a
            ...
            <c:if test="${curPage.curPage!=curPage.totalPage}">
                <a class="layui-btn"
                    href="${pageContext.request.contextPath }/admin/selMajorByPage?curPage=${curPage.totalPage }">尾页</a>
            </c:if>
        </div>
    </c:if>
    <script>
