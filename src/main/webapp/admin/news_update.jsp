...
<body>
    ...
    <div
        ...
        <a href="${pageContext.request.contextPath}/admin/selNewsByPage"><i
    ...
    <div style="width: 750px; margin: 10px auto;">
        <form class="layui-form layui-form-pane" name="form1"
            action="${pageContext.request.contextPath}/admin/updNews">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" id="id" name="id" class="layui-input"
                        style="color: rgba(57, 61, 73, 0.5)" value="${news.id }"
                        readonly="readonly" />
                </div>
            </div>
            ...
            <div class="layui-form-item">
                <label class="layui-form-label"
                    style="background-color: rgba(57, 61, 73, 0.1)">发布人:</label>
                <div class="layui-input-block">
                    <input type="text" name="people" id="people" style="color: rgba(57, 61, 73, 0.5)" value="${news.people }" class="layui-input" readonly="readonly" />
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="time" id="time" value="${news.time }" class="layui-input" />

                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label"
                    style="background-color: rgba(57, 61, 73, 0.1)">点击数量:</label>
                <div class="layui-input-block">
                    <input type="text" name="count" id="count" value="${news.count }" style="color: rgba(57, 61, 73, 0.5)" class="layui-input" readonly="readonly"/>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" id="title" name="title" class="layui-input"
                        value="${news.title }" lay-verify="required" />
                </div>
            </div>
            ...
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                    <textarea name="content" placeholder="请输入内容" class="layui-textarea"
                        lay-verify="required">${news.content}</textarea>
                </div>
            </div>
