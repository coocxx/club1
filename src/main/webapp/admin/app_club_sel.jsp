...
<body>
    ...
    <div
        ...
        <a href="${pageContext.request.contextPath}/admin/selAppClubByPage"><i
    ...
    <div style="height: 550px; width: 750px; margin: 10px auto;">
        <form class="layui-form layui-form-pane" name="form1"
            action="${pageContext.request.contextPath}/admin/updAppClub">
                ...
                <div class="layui-input-block" style="">
                    <c:if test="${clubApply.status==2 }">
                            <a class="layui-btn layui-btn-radius"
                                href="${pageContext.request.contextPath }/admin/updAppClubStatus?id=${clubApply.id }&studentId=${clubApply.studentId }&name=${clubApply.name }&clubTypeId=${clubApply.clubTypeId }&status=1"
                                onclick="return updConfirm()">通过</a>
                    </c:if>

                    <c:if test="${clubApply.status==2 }">
                            <a class="layui-btn layui-btn-radius layui-btn-warm"
                                href="${pageContext.request.contextPath }/admin/updAppClubStatusR?id=${clubApply.id }&studentId=${clubApply.studentId }&status=0"
