...
<body>
	...
	<div
		...
		<a href="${pageContext.request.contextPath}/admin/selNoticeByPage"><i
	...
	<div style="width: 750px; margin: 10px auto;">
		<form class="layui-form layui-form-pane" name="form1"
			action="${pageContext.request.contextPath}/admin/updNotice">
                    ...
                    <select name="club.id" id="clubId">
                        <c:if test="${clubs!=null }">
                            <c:forEach items="${clubs }" var="i">
                                <c:if test="${i.id == notice.club.id}">
                                    <option value="${notice.club.id  }"
