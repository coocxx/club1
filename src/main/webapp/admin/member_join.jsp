...
<body>
    ...
    <div
        ...
        <form class="layui-form" method="post" name="form1"
            ...
            action="${pageContext.request.contextPath }/admin/selMemberJoins">
    ...
    <c:if test="${ curPage.data!=null && curPage.data.size()!=0 }">
                        ...
                        <tr>
                            ...
                            <td>
                              <div> <a class="layui-btn layui-btn-radius layui-btn-normal"
                                href="${pageContext.request.contextPath }/admin/selMemberJoinById?id=${i.id }" >详情</a>
                                </div><div>
                                <c:if test="${i.status==2 }"><div><a class="layui-btn layui-btn-radius"
                                href="${pageContext.request.contextPath }/admin/updMemberJoinStatus?id=${i.id }&studentId=${i.student.id }&clubId=${i.club.id }&status=1" onclick="return updConfirm()">通过</a>
                                </div></c:if>
                                
                                <c:if test="${i.status==2 }"><div><a class="layui-btn layui-btn-radius layui-btn-warm"
                                href="${pageContext.request.contextPath }/admin/updMemberJoinStatusR?id=${i.id }&studentId=${i.student.id }&status=0" onclick="return rejConfirm()">拒绝</a>
                                </c:if></div>
                              <c:if test="${i.status==1 || i.status==0}"><div><a class="layui-btn layui-btn-radius layui-btn-warm"
                                href="${pageContext.request.contextPath }/admin/delMemberJoin?id=${i.id }"
        ...
        <div style="margin: 10px 0px 10px 380px">
            ...
            <c:if test="${curPage.curPage!=1}">
                <a class="layui-btn"
                    href="${pageContext.request.contextPath }/admin/selMemberJoinByPage?curPage=1">首页</a>
            </c:if>
            <!-- 上一页 -->
            <c:if test="${curPage.curPage<=1}">
                <a class="layui-btn layui-btn-primary"
            ...
            <c:if
                ...
                <a class="layui-btn"
                    href="${pageContext.request.contextPath }/admin/selMemberJoinByPage?curPage=${curPage.curPage-1 }"><i
            ...
            <c:if test="${curPage.curPage!=curPage.totalPage}">
                <a class="layui-btn"
                    href="${pageContext.request.contextPath }/admin/selMemberJoinByPage?curPage=${curPage.totalPage }">尾页</a>
            </c:if>
        </div>
    </c:if>
    <script>
