...
<body>
    ...
    <div style="margin: 30px 0px 0px 220px; align: center; color: rgba(57, 61, 73, 0.7)">
         <a href="${pageContext.request.contextPath}/admin/selAcademyByPage"><i class="layui-icon"> &#xe603;返回</i></a>
     </div>
    <h2
        ...
        <form class="layui-form layui-form-pane" name="form1" 
            ...
            <div class="layui-form-item" >
                ...
                <div class="layui-input-block">
                    <input type="text" name="academyId" class="layui-input" style="text-align:center"
                        value="${classes.major.academy.id }" readonly="readonly"/>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label" style="background-color: rgba(57, 61, 73, 0.1)">学院名</label>
                <div class="layui-input-block">
                    <input type="text"name="academyName" class="layui-input" style="text-align:center"
                        value="${classes.major.academy.name }" readonly="readonly"/>
                </div>
            </div>
            <div class="layui-form-item" >
                <label class="layui-form-label" style="background-color: rgba(57, 61, 73, 0.1)">专业号</label>
                <div class="layui-input-block">
                    <input type="text" name="majorId" class="layui-input" style="text-align:center"
                        value="${classes.major.id }" readonly="readonly"/>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label" style="background-color: rgba(57, 61, 73, 0.1)">专业名</label>
                <div class="layui-input-block">
                    <input type="text" name="majorName" class="layui-input" style="text-align:center"
                        value="${classes.major.name }" readonly="readonly"/>
                </div>
            </div>
            ...
            <div class="layui-form-item" >
                ...
                <div class="layui-input-block">
                    <input type="text" id="id" name="id" class="layui-input" style="text-align:center"
                        value="${classes.id }" readonly="readonly"/>
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label" style="background-color: rgba(57, 61, 73, 0.1)">班级名</label>
                <div class="layui-input-block">
                    <input type="text" id="name" name="name" class="layui-input" style="text-align:center"
                        value="${classes.name }" readonly="readonly"/>
                </div>
            </div>
