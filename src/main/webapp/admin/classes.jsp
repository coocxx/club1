...
<body>
    ...
    <div style="margin:0px auto;background-color:rgba(57, 61, 73, 0.1);height:170px;">
        ...
        <form class="layui-form" method="post" name="form1" style="margin-left:70px;padding-top: 20px;"
            action="${pageContext.request.contextPath }/admin/selClasses">
            <div class="layui-form-item">
                <div class="layui-inline">
                    <label class="layui-form-label">学院号:</label>
                    <div class="layui-input-inline" style="width: 150px;">
                        <input type="text" name="major.academy.id" id="academyId" class="layui-input" />
                    </div>
                </div>
                <div class="layui-inline">
                    <label class="layui-form-label">学院名:</label>
                    <div class="layui-input-inline" style="width: 150px;">
                        <input type="text" name="major.academy.name"  class="layui-input" />
                    </div>
                </div>
                <div class="layui-inline">
                    <label class="layui-form-label">专业号:</label>
                    <div class="layui-input-inline" style="width: 150px;">
                        <input type="text" name="major.id"  id="majorId" class="layui-input" />
                    </div>
                </div>
                <div class="layui-inline">
                    <label class="layui-form-label">专业名称:</label>
                    <div class="layui-input-inline" style="width: 150px;">
                        <input type="text" name="major.name"  class="layui-input" />
                    </div>
                </div>
                <div class="layui-inline">
                ...
                <div class="layui-inline ">
                   <div class="layui-input-block" style="margin-top:10px;margin-left:350px" >
    ...
    <c:if test="${ curPage.data!=null && curPage.data.size()!=null }">
            ...
            <table class="layui-table" style="text-align:center">
                ...
                <thead>
                    <tr >
                        ...
                        <th style="text-align:center">专业号</th>
                ...
                <tbody>
                    <c:forEach items="${curPage.data }" var="i">
                        <tr>
                            <td>${i.major.academy.id }</td>
                            <td>${i.major.academy.name }</td>
                            <td>${i.major.id }</td>
                            <td>${i.major.name }</td>
                            <td>${i.id }</td>
                            <td>${i.name }</td>
                            <td><a class="layui-btn layui-btn-radius layui-btn-normal"
                                href="${pageContext.request.contextPath }/admin/selClassesById?id=${i.id }">详情</a>
                               
                            <%-- <a class="layui-btn layui-btn-radius"
                                href="${pageContext.request.contextPath }/admin/delClubType?id=${i.id }"
                                onclick="return delConfirm()"><i class="layui-icon">&#xe640;删除</i></a>
                              </td>    --%>     
                        </tr>
                    </c:forEach>
                </tbody>
        ...
        <div style="margin: 10px 0px 10px 380px">
            ...
            <c:if test="${curPage.curPage!=1}">
                <a class="layui-btn"
                    href="${pageContext.request.contextPath }/admin/selClassesByPage?curPage=1">首页</a>
            </c:if>
            <!-- 上一页 -->
            <c:if test="${curPage.curPage<=1}">
                <a class="layui-btn layui-btn-primary"
            ...
            <c:if
                ...
                <a class="layui-btn"
                    href="${pageContext.request.contextPath }/admin/selClassesByPage?curPage=${curPage.curPage-1 }"><i class="layui-icon layui-icon-left"></i></a>
            </c:if>
            <!-- 下一页 -->
            ...
            <c:if
                test="${(curPage.curPage>=1) && (curPage.curPage<curPage.totalPage)}">
                <a class="layui-btn"
                    href="${pageContext.request.contextPath }/admin/selClassesByPage?curPage=${curPage.curPage+1 }"><i class="layui-icon">&#xe602;</i></a>
            </c:if>
            <!-- 尾页 -->
            <c:if test="${curPage.curPage==curPage.totalPage}">
                <a
            ...
            <c:if test="${curPage.curPage!=curPage.totalPage}">
                <a class="layui-btn"
                    href="${pageContext.request.contextPath }/admin/selClassesByPage?curPage=${curPage.totalPage }">尾页</a>
            </c:if>
        </div>
    </c:if>
    <script>
