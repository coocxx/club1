...
<body>
	...
	<div
		...
		<a href="${pageContext.request.contextPath}/admin/selMemberJoinByPage?active=pr"><i
				...
				<div class="layui-input-block" style="margin-left: 230px">
					<c:if test="${member.status==2 }">
						...
						<a class="layui-btn layui-btn-radius" style="width: 130px"
							href="${pageContext.request.contextPath }/admin/updMemberJoinStatus?active=pr&id=${member.id }&studentId=${member.student.id }&clubId=${member.club.id }&status=1"
					...
					<c:if test="${member.status==2 }">
						...
						<a class="layui-btn layui-btn-warm layui-btn-radius"
							style="width: 130px"
							href="${pageContext.request.contextPath }/admin/updMemberJoinStatusR?active=pr&id=${member.id }&status=0"
					...
					<c:if test="${member.status==1 || member.status==0}">
						...
						<a class="layui-btn layui-btn-radius" style="width: 130px"
							href="${pageContext.request.contextPath }/admin/delMemberJoin?active=pr&id=${member.id }"
							onclick="return delConfirm()">删除</a>
						<a class="layui-btn layui-btn-radius layui-btn-primary"
							style="width: 130px"
							href="${pageContext.request.contextPath}/admin/selMemberJoinByPage?active=pr&">返回</a>
					</c:if>
