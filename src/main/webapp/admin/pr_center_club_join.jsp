                    ...
                    <c:forEach items="${clubs }" var="i">
                        <tr>
                            ...
                            <c:if test="${i.status==2 }">
                                <td><a class="layui-btn layui-btn-normal" href="${pageContext.request.contextPath}/admin/cancelJoin?id=${i.id}" onclick="return stopConfirm();">撤销加入该社团</a>
                            </td></c:if>
                        </tr>
                    </c:forEach>
                </tbody>
