...
<body
	...
	<div class="container" style="margin-top: 60px">
		<main>
		<div class="login"
			style="height: 440px; width: 600px; margin: 0px auto; background-color: white;">
			...
			<div class="content"
				...
				<ul>
					...
					<li style="display: inline-block; margin: 0px 30px 25px 20px"><a
						...
						style="color: rgba(57, 61, 73, 0.5); font-size: 17px;">超级管理员</a></li>
					<li style="display: inline-block; margin: 30px 0px 25px 10px"><a
						href="${pageContext.request.contextPath }/admin/prsdt_login.jsp"
						style="color: rgb(47, 169, 158); font-size: 17px;">社团管理员</a></li>
				</ul>

				<!-- return verifyLogin() -->
				<form class="layui-form form1" name="form1"
					action="${pageContext.request.contextPath }/admin/prLogin"
					method="post">
					<div class="layui-form-item" class="pwd">
						<div class="layui-input-block">
							<input type="text" id="id" placeholder="学号"
								value="${president.student.id }"
								style="height: 43px; width: 390px" class="layui-input"
								name="student.id" lay-verify="sid" />
						</div>
					</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<input type="password" id="password"
								style="height: 43px; width: 390px" placeholder="密码"
								name="student.password" value="" class="layui-input"
								lay-verify="required" lay-reqText="密码不能为空" />
						</div>
					</div>
		...
		<!-- <footer style="height:90px; text-align: center;background-image:url('images/bgd1.png'); border: rgba(153,16,16,0.1) solid thin;background-color: rgb(57,61,73,0.1)">
            <p style="color: white; font-size: 12px; text-align: center; padding-top: 40px;">青岛科技大学(©版权所有)</p>
        </footer> -->
	</div>
	<script>
