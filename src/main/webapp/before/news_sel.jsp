                ...
                <div class="layui-row layui-col-space10 ">
                            ...
                            <div class="layui-col-md" style="margin: 20px 0px 30px 0px">
                                ...
                                <div class="layui-card" class="turn">
                                    ...
                                    <div class="layui-card-header">
                                        <p style="color: green;">新闻动态</p>
                                    </div>
                                    <c:forEach items="${newss }" var="i">
                    ...
                    <div class="layui-col-md9">
                        <div style="margin-left: 30px">
                            ...
                            <h5>
                                当前位置&nbsp;:&nbsp;<a
                                    ...
                                    href="${pageContext.request.contextPath }/before/selNewsById">动态新闻</a>&nbsp;>>&nbsp;<a
                                    href="${pageContext.request.contextPath }/before/selNewsById?id=${news.id}">${news.title }</a>
                            </h5>
                            <hr />
                        </div>
                        <div class="layui-row layui-col-space5"
                            ...
                            <div style="">
                                <h3 style="text-align: center; margin-top: 20px;margin-bottom: 10px;color: green;">${news.title }</h3>
                                ...
                                <div
                                    ...
                                    <p style="margin-top: 3px; text-indent: 2em; margin-bottom: 10px;"
                                        class="turn">${news.content }</p>
                                    <div style="margin: 3px; margin-bottom: 25px" >
                                        <div style="margin: 3px;">
                                            <span style="color: green;">发布时间：</span>
                                            <p style="text-indent: 2em; color: grey; margin: 5px;">${news.time }</p>
                                        </div>
