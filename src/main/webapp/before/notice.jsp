							...
							<div class="layui-col-md" style="margin: 20px 0px 30px 0px">
								...
								<div class="layui-card" class="turn">
									...
									<div class="layui-card-header">
										<p style="color: green;">公告来源的社团</p>
									</div>
									<c:forEach items="${clubs }" var="i">
										<div class="layui-card-header" style="overflow: hidden;">
											<a
												href="${pageContext.request.contextPath }/before/selNoticesById?clubId=${i.id}">${i.name }</a>
										</div>
									</c:forEach>
								</div>
					...
					<div class="layui-col-md9" style="">
						<div style="margin-left: 30px; margin-top: 20px;">
							...
							<h5>
								当前位置&nbsp;:&nbsp;<a
									...
									href="${pageContext.request.contextPath }/before/selNoticesById?clubId=${club.id}">${club.name }</a><%-- &nbsp;>>&nbsp;
								<a
									href="${pageContext.request.contextPath }}/before/selNoticesById?id=${notice.id}&clubId=${notice.clubId}">${notice.title }</a> --%>
							</h5>
							<hr />
						</div>
						<div class="layui-row layui-col-space5"
							...
							<div style="margin-top: 20px;">
								<h3 style="text-align: center; margin-top: 20px; color: green;">${club.name }公告</h3>
								...
								<div class="layui-col-md6" style="margin-top: 20px;">
									...
									<c:forEach items="${notices }" var="i">
										<div class="layui-card-header"
											...
											<a href="${pageContext.request.contextPath }/before/selNoticesOfClub?id=${i.id}&clubId=${i.club.id}">${i.title }</a>
											<p style="display: inline-block; float: right;">${i.time }</p>
										</div>
									</c:forEach>
								</div>
